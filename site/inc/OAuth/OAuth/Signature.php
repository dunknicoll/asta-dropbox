...
require_once JPATH_SITE . '/components/com_dropbox/inc/OAuth/OAuth.php';
...
abstract class HTTP_OAuth_Signature
{
    ...
    static public function factory($method)
    {
        ...
        $method = str_replace('_', '/', $method) . '.php';
        
        $file   = str_replace('_', '/', $class) . '.php';
        
        
        include_once JPATH_SITE . '/components/com_dropbox/inc/OAuth/OAuth/Signature/Common.php';
        include_once JPATH_SITE . '/components/com_dropbox/inc/OAuth/OAuth/Signature/' . $method;
